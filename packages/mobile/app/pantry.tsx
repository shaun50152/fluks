...
const styles = StyleSheet.create({
  ...
  formTitle: { fontSize: FontSize.lg, fontWeight: FontWeight.bold as any, color: Colors.text, marginBottom: Spacing.sm },
  input: {
    borderWidth: 1,
  ...
  itemName: { fontSize: FontSize.md, fontWeight: FontWeight.semibold as any, color: Colors.text },
  itemQuantity: { fontSize: FontSize.sm, color: Colors.textSecondary, marginBottom: Spacing.sm },
