  ...
  return (
    <View style={styles.settingRow}>
      ...
      <Switch
        ...
        trackColor={{ false: BrandColors.muted + '44', true: BrandColors.primaryLight }}
        thumbColor={value ? BrandColors.primary : BrandColors.muted}
      ...
      <Card style={styles.card}>
        <View style={styles.settingRow}>
          ...
          <Switch
            ...
            trackColor={{ false: BrandColors.muted + '44', true: BrandColors.primaryLight }}
            thumbColor={quietEnabled ? BrandColors.primary : BrandColors.muted}
...
const styles = StyleSheet.create({
  ...
  divider: { height: StyleSheet.hairlineWidth, backgroundColor: BrandColors.muted + '44', marginHorizontal: Spacing.md },
  settingRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  settingLabel: { fontSize: FontSize.md, fontWeight: FontWeight.medium as any, color: BrandColors.text },
  settingDesc: { fontSize: FontSize.xs, color: BrandColors.textSecondary, marginTop: 2 },
  fieldLabel: { fontSize: FontSize.sm, color: BrandColors.textSecondary, marginBottom: Spacing.xs },
  timeRow: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, paddingHorizontal: Spacing.md, paddingVertical: Spacing.sm },
  timeField: { flex: 1 },
  timeSep: { fontSize: FontSize.lg, color: BrandColors.textSecondary },
  timeInput: {
    borderWidth: 1,
    borderColor: BrandColors.muted + '88',
  ...
  deleteBtn: { borderWidth: 1, borderColor: BrandColors.error },
  emptyText: { fontSize: FontSize.sm, color: BrandColors.textSecondary, padding: Spacing.md },
  errorText: { fontSize: FontSize.xs, color: BrandColors.error, paddingHorizontal: Spacing.md },
  // Meal window row
  ...
  mealWindowDay: { fontSize: FontSize.sm, fontWeight: FontWeight.semibold as any, color: BrandColors.text, width: 32 },
  mealWindowTime: { fontSize: FontSize.sm, color: BrandColors.textSecondary },
  manualBadge: {
  ...
  editLink: { fontSize: FontSize.sm, color: BrandColors.primary, fontWeight: FontWeight.medium as any, marginLeft: 'auto' },
