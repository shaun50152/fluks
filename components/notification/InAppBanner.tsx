...
import { BrandColors, BorderRadius, Spacing, FontSize, FontWeight, Shadows } from '@/constants/theme';
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: FontSize.md, fontWeight: FontWeight.semibold as any, color: BrandColors.text, marginBottom: Spacing.xs },
  body: { fontSize: FontSize.sm, color: BrandColors.textSecondary },
});
